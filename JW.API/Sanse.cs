...
namespace JW.API
{
    public class Sanse
    {
        public static bool GetCustomerOnhandByStyleList(string SupplyID,string url,string key,string customerID,string styleList,out string datajson)
        {
            ...
            {
                DB.LogSystem.AddLog(isok, "供应商库存接口", "获取", msg, datajson, parasOld.ExDictToJsonString(), dateb, DateTime.Now);
            }
            return isok;
        }
    }
