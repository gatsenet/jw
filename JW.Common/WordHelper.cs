...
namespace JW.Common
{
    public class WordHelper
    {
        ...
        /// <returns></returns>  
        public bool CreateNewWordDocument(string templateName, string HT_No)
        {
            try
            {
                return CreateNewWordDocument(templateName, ref wDoc, ref wApp, HT_No);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        /// <returns></returns>  
        public bool CreateNewWordDocument(string templateName, ref Word.Document wDoc, ref Word.Application WApp, string HT_No)
        {
            //killWinWordProcess();
            ...
            try
            {
                ...
                if (thisApplication.ActiveWindow.ActivePane.View.Type == WdViewType.wdNormalView || thisApplication.ActiveWindow.ActivePane.View.Type == WdViewType.wdOutlineView)
                {
                    thisApplication.ActiveWindow.ActivePane.View.Type = WdViewType.wdPrintView;
                }


                //去掉页眉的那条横线
                thisApplication.ActiveWindow.ActivePane.Selection.ParagraphFormat.Borders[Microsoft.Office.Interop.Word.WdBorderType.wdBorderBottom].LineStyle = Word.WdLineStyle.wdLineStyleNone;
                thisApplication.ActiveWindow.ActivePane.Selection.Borders[Microsoft.Office.Interop.Word.WdBorderType.wdBorderBottom].Visible = false;
                // thisApplication.ActiveWindow.ActivePane.View.SeekView = Word.WdSeekView.wdSeekMainDocument;//退出页眉设置

                //thisApplication.ActiveWindow.View.SeekView = WdSeekView.wdSeekCurrentPageHeader;
                //thisApplication.Selection.HeaderFooter.LinkToPrevious = false;
                //thisApplication.Selection.HeaderFooter.Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                //thisApplication.Selection.HeaderFooter.Range.Text = "页眉内容";


                thisApplication.ActiveWindow.View.SeekView = WdSeekView.wdSeekCurrentPageFooter;
                thisApplication.Selection.HeaderFooter.LinkToPrevious = false;
                thisApplication.Selection.HeaderFooter.Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                // thisApplication.ActiveWindow.ActivePane.Selection.InsertAfter("页脚内容");
                thisApplication.Selection.TypeText("第");
                thisApplication.Selection.Fields.Add(thisApplication.Selection.Range, ref CurrentPage, ref Nothing, ref Nothing);
                thisApplication.Selection.TypeText("页/共");
                object pages = Microsoft.Office.Interop.Word.WdFieldType.wdFieldNumPages;
                thisApplication.Selection.Fields.Add(thisApplication.Selection.Range, ref pages, ref Nothing, ref Nothing);

                thisApplication.Selection.TypeText("页");
                thisApplication.Selection.TypeText("(合同编号:" + HT_No + ")");

                //跳出页眉页脚设置
                thisApplication.ActiveWindow.View.SeekView = WdSeekView.wdSeekMainDocument;
        ...
        public static bool SaveAs(string fileName, Word.Document wDoc)
        {
            ...
            Object FileFormat = Word.WdSaveFormat.wdFormatPDF;// 文档的保存格式。可以是任何 WdSaveFormat 值。要以另一种格式保存文档，请为 SaveFormat 属性指定适当的值。
        ...
        {
            Object SaveChanges = Word.WdSaveOptions.wdDoNotSaveChanges;// 指定文档的保存操作。可以是下列 WdSaveOptions 值之一：wdDoNotSaveChanges、wdPromptToSaveChanges 或 wdSaveChanges
        ...
        ///获取文档中所有标签
        ///
        public void GetDocumentBookmarkData(string FileName, ref string[] bookmarks, string HT_No)
        {

            Word.Document wDoc = null;
            Word.Application wApp = null;
            CreateNewWordDocument(FileName, ref wDoc, ref wApp, HT_No);
